...
class DataDokumenPelaporanController extends Controller
{
    ...
    private function exportExcel($data)
    {
        ...
        $fileName = 'Pelaporan_Dokumen_' . $currentDate . '.xlsx';

        return Excel::download(
            new \App\Exports\DataDokumenPelaporanExport($dataDokumens, $filters),
            $fileName
        );
    }
