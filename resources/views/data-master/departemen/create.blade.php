            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-plus me-2"></i>Tambah Departemen</span>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="kode_dep"
                                                        name="kode_dep" value="{{ old('kode_dep') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="nama_dep"
                                                        name="nama_dep" value="{{ old('nama_dep') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="singkatan_dep"
                                                        name="singkatan_dep" value="{{ old('singkatan_dep') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="nama_jbt"
                                                        name="nama_jbt" value="{{ old('nama_jbt') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="singkatan_jbt"
                                                        name="singkatan_jbt" value="{{ old('singkatan_jbt') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
