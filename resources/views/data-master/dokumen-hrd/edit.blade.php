            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-file-alt me-2"></i>Edit Dokumen HRD</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dokumen-hrd.update', $dokumen->id) }}" method="POST" id="dokumenHrdForm">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control auto-uppercase" id="kode_dok_hrd"
                                                name="kode_dok_hrd" value="{{ old('kode_dok_hrd', $dokumen->kode_dok_hrd) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control auto-uppercase" id="ktg_dok_hrd"
                                                name="ktg_dok_hrd" value="{{ old('ktg_dok_hrd', $dokumen->ktg_dok_hrd) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control auto-uppercase" id="jns_dok_hrd"
                                                name="jns_dok_hrd" value="{{ old('jns_dok_hrd', $dokumen->jns_dok_hrd) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
