                    ...
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group" role="group">
                            @if (auth()->user()->is_admin || ($userPermissions['ubah'] ?? false))
                                <a href="{{ route('dokumen-karyawan.edit', $dokumen->id) }}" class="btn btn-warning btn-sm">
                    ...
                    <div class="card-body">
                        <form>
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="kode_dok_kry" class="form-label fw-bold">Kode Dokumen</label>
                                        <input type="text" class="form-control" id="kode_dok_kry"
                                            value="{{ $dokumen->kode_dok_kry }}" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ktg_dok_kry" class="form-label fw-bold">Kategori Dokumen</label>
                                        <input type="text" class="form-control" id="ktg_dok_kry"
                                            value="{{ $dokumen->ktg_dok_kry }}" disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="jns_dok_kry" class="form-label fw-bold">Jenis Dokumen</label>
                                        <input type="text" class="form-control" id="jns_dok_kry"
                                            value="{{ $dokumen->jns_dok_kry ?? '-' }}" disabled>
                                    </div>
                                </div>
                            </div>
