                                        ...
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="kode_prs"
                                                        name="kode_prs" value="{{ old('kode_prs') }}" required>
                                                </div>
                                            </div>
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="nama_prs1"
                                                        name="nama_prs1" value="{{ old('nama_prs1') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase"
                                                        id="nama_prs2" name="nama_prs2" value="{{ old('nama_prs2') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control auto-uppercase" id="alamat_prs" name="alamat_prs" rows="3" required>{{ old('alamat_prs') }}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="rt_rw_prs" name="rt_rw_prs" value="{{ old('rt_rw_prs') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control auto-uppercase" id="kel_prs" name="kel_prs" value="{{ old('kel_prs') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-map"></i></span>
                                                            <input type="text" class="form-control auto-uppercase" id="kec_prs" name="kec_prs" value="{{ old('kec_prs') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="kd_pos_prs" name="kd_pos_prs" value="{{ old('kd_pos_prs') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control auto-uppercase" id="kota_prs" name="kota_prs" value="{{ old('kota_prs') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control auto-uppercase" id="prov_prs" name="prov_prs" value="{{ old('prov_prs') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="tlp1" name="tlp1" value="{{ old('tlp1') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="tlp2" name="tlp2" value="{{ old('tlp2') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" class="form-control" id="tgl_pendirian" name="tgl_pendirian" value="{{ old('tgl_pendirian') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="bidang_ush" name="bidang_ush" value="{{ old('bidang_ush') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="ijin_ush" name="ijin_ush" value="{{ old('ijin_ush') }}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div style="flex: 1">
                                                        <select class="form-select select2" id="golongan_ush" name="golongan_ush">
                                                            ...
                                                            <option value="-" {{ old('golongan_ush') == '-' ? 'selected' : '' }}>-</option>
                                                            <option value="MIKRO" {{ old('golongan_ush') == 'MIKRO' ? 'selected' : '' }}>MIKRO</option>
                                                            <option value="KECIL" {{ old('golongan_ush') == 'KECIL' ? 'selected' : '' }}>KECIL</option>
                                                            <option value="MENENGAH" {{ old('golongan_ush') == 'MENENGAH' ? 'selected' : '' }}>MENENGAH</option>
                                                            <option value="BESAR" {{ old('golongan_ush') == 'BESAR' ? 'selected' : '' }}>BESAR</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="dirut" name="dirut" value="{{ old('dirut') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-user-tie"></i></span>
                                                    <input type="text" class="form-control auto-uppercase" id="direktur" name="direktur" value="{{ old('direktur') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-user-tie"></i></span>
                                                    <input type="text" class="form-control auto-uppercase" id="komisaris_utm" name="komisaris_utm" value="{{ old('komisaris_utm') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-user-tie"></i></span>
                                                    <input type="text" class="form-control auto-uppercase" id="komisaris1" name="komisaris1" value="{{ old('komisaris1') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
