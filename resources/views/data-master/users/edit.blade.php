                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="nama_kry" name="nama_kry"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="jabatan_kry"
                                                        name="jabatan_kry"
                                            ...
                                            <div class="form-group mb-3" id="confirmation-group">
                                                ...
                                                <div class="form-text text-muted"><i
                                                        class="fas fa-info-circle me-1"></i>Hanya wajib diisi jika mengubah
                                                    password</div>
                                            </div>
                                        </div>
                                    </div>
