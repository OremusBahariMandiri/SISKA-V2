            ...
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-map-plus me-2"></i>Tambah Wilayah Kerja</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('wilayah-kerja.store') }}" method="POST" id="wilayahKerjaForm" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="card-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="kode_wk"
                                                        name="kode_wk" value="{{ old('kode_wk') }}" required>
                                                </div>
                                            </div>
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="wilayah_krj"
                                                        name="wilayah_krj" value="{{ old('wilayah_krj') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase" id="area_krj"
                                                        name="area_krj" value="{{ old('area_krj') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control auto-uppercase"
                                                        id="singkatan_wk" name="singkatan_wk" value="{{ old('singkatan_wk') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control auto-uppercase" id="alamat_wk" name="alamat_wk" rows="3" required>{{ old('alamat_wk') }}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="rt_rw_wk" name="rt_rw_wk" value="{{ old('rt_rw_wk') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-map"></i></span>
                                                            <input type="text" class="form-control auto-uppercase" id="kel_wk" name="kel_wk" value="{{ old('kel_wk') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i class="fas fa-map"></i></span>
                                                            <input type="text" class="form-control auto-uppercase" id="kec_wk" name="kec_wk" value="{{ old('kec_wk') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" id="kd_pos_wk" name="kd_pos_wk" value="{{ old('kd_pos_wk') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control auto-uppercase" id="kota_wk" name="kota_wk" value="{{ old('kota_wk') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control auto-uppercase" id="prov_wk" name="prov_wk" value="{{ old('prov_wk') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
