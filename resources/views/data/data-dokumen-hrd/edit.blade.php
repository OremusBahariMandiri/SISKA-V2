...
@section('title', 'Edit Data Dokumen HRD')
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold"><i class="fas fa-file-contract me-2"></i>Edit Data Dokumen HRD</span>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('data-dokumen-hrd.update', $dataDokumenHrd->id) }}" method="POST"
                            id="dokumenHrdForm" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card border-primary mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label for="kode_dok_hrd_display" class="form-label fw-bold">Kode Dokumen
                                                    <span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <span class="input-group-text"><i class="fas fa-barcode"></i></span>
                                                    <input type="text" class="form-control bg-light"
                                                        id="kode_dok_hrd_display"
                                                        value="{{ old('kode_dok_hrd', optional($dataDokumenHrd->dokumenHrd)->kode_dok_hrd) }}"
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div style="flex: 1">
                                                        <select class="form-select select2" id="jns_msb_dok"
                                                            ...
                                                            <option value="TETAP"
                                                                {{ old('jns_msb_dok', $dataDokumenHrd->jns_msb_dok) == 'TETAP' ? 'selected' : '' }}>
                                                                TETAP
                                                            </option>
                                                            <option value="PERPANJANGAN"
                                                                {{ old('jns_msb_dok', $dataDokumenHrd->jns_msb_dok) == 'PERPANJANGAN' ? 'selected' : '' }}>
                                                                PERPANJANGAN
                                                            </option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" class="form-control" id="tgl_akr_dok"
                                                    name="tgl_akr_dok"
                                                    value="{{ old('tgl_akr_dok', $dataDokumenHrd->tgl_akr_dok ? $dataDokumenHrd->tgl_akr_dok->format('Y-m-d') : '') }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="msb_dok"
                                                        name="msb_dok"
                                                        value="{{ old('msb_dok', $dataDokumenHrd->msb_dok) }}"
                                                        min="1" readonly>
                                                </div>
                                                <div class="form-text text-muted">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" class="form-control" id="tgl_prt_dok"
                                                    name="tgl_prt_dok"
                                                    value="{{ old('tgl_prt_dok', $dataDokumenHrd->tgl_prt_dok ? $dataDokumenHrd->tgl_prt_dok->format('Y-m-d') : '') }}">
                                                <div class="form-text text-muted">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="durasi_pgt"
                                                        name="durasi_pgt"
                                                        value="{{ old('durasi_pgt', $dataDokumenHrd->durasi_pgt) }}"
                                                        readonly>
                                                </div>
                                                <div class="form-text text-muted">
                                                    <i class="fas fa-info-circle me-1"></i>Otomatis dihitung dari
                                                    tanggal hari ini ke tanggal peringatan
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div style="flex: 1">
                                                        <select class="form-select select2" id="sts_dok" name="sts_dok"
                                                            ...
                                                            <option value="AKTIF"
                                                                {{ old('sts_dok', $dataDokumenHrd->sts_dok) == 'AKTIF' ? 'selected' : '' }}>
                                                                AKTIF
                                                            </option>
                                                            <option value="NON-AKTIF"
                                                                {{ old('sts_dok', $dataDokumenHrd->sts_dok) == 'NON-AKTIF' ? 'selected' : '' }}>
                                                                NON-AKTIF
                                                            </option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="col-md-6" id="field_tgl_dok_na" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" class="form-control" id="tgl_dok_na"
                                                    name="tgl_dok_na"
                                                    value="{{ old('tgl_dok_na', $dataDokumenHrd->tgl_dok_na ? $dataDokumenHrd->tgl_dok_na->format('Y-m-d') : '') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6" id="field_ket_dok_na" style="display: none;">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control auto-uppercase" id="ket_dok_na" name="ket_dok_na" rows="3"
                                                    placeholder="Alasan status non aktif">{{ old('ket_dok_na', $dataDokumenHrd->ket_dok_na) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                ...
                                <button type="submit" class="btn btn-success btn-lg" id="submitBtn">
                                    <i class="fas fa-save me-2"></i> Update Data Dokumen HRD
                                </button>
                            </div>
                        </form>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        const selectedKategori = "{{ old('ktg_dok_hrd', optional($dataDokumenHrd->dokumenHrd)->ktg_dok_hrd) }}";
        const selectedJenisDokumen = "{{ old('jns_dok_hrd', optional($dataDokumenHrd->dokumenHrd)->jns_dok_hrd) }}";
        const selectedIdDokumen = "{{ old('id_dokumen_hrd', $dataDokumenHrd->id_dokumen_hrd) }}";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize other functions first
            handleJenisMasaBerlakuChange();
            handleStatusDokumenChange();

            // Initialize on page load - trigger cascading dropdown
            if (selectedKategori) {
                // Set kategori value first
                $('#ktg_dok_hrd').val(selectedKategori);

                // Trigger change to populate jenis dropdown
                $('#ktg_dok_hrd').trigger('change');

                // Wait for kategori change to complete, then set jenis
                if (selectedKategori) {
                    $('#ktg_dok_hrd').val(selectedKategori).trigger('change');

                    setTimeout(function() {
                        if (selectedJenisDokumen) {
                            $('#jns_dok_hrd').val(selectedJenisDokumen).trigger('change');
                        }
                    }, 200);
                }
            } else {
