            ...
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <x-data-filter route="{{ route('data-dokumen-laporan.index') }}" :filters="$currentFilters" :options="$filterOptions"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            @foreach ($perusahaans as $perusahaan)
                                @php
                                    $count = $dataDokumens->filter(function($d) use ($perusahaan) {
                                        return $d->karyawan && $d->karyawan->perusahaan == $perusahaan->id;
                                    })->count();
                                @endphp
                                @if ($count > 0)
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            @foreach ($dokumenTypes as $dokumenType)
                                @php
                                    $count = $dataDokumens->where('id_dokumen', $dokumenType->id)->count();
                                @endphp
                                @if ($count > 0)
                                    <div class="col-md-4 col-lg-3 mb-3">
                                        <div class="card border-left-secondary shadow-sm h-100">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <p class="mb-0 fw-bold text-truncate" title="{{ $dokumenType->nama_dok }}" style="max-width: 150px;">
                                                            {{ Str::limit($dokumenType->singkatan_dok ?? $dokumenType->nama_dok, 20) }}
                                                        </p>
                                                    </div>
                                                    <div class="text-end">
                    ...
                    <!-- By Kategori -->
                    <div class="mb-4">
                        <h5 class="fw-bold mb-3"><i class="fas fa-tags me-2 text-info"></i>Berdasarkan Kategori Dokumen</h5>
                        <div class="row">
                            @foreach ($kategoriDokumenOptions as $kategori)
                                @php
                                    $count = $dataDokumens->filter(function($d) use ($kategori) {
                                        return $d->dokumenType && $d->dokumenType->ktg_dok_kry == $kategori->ktg_dok_kry;
                                    })->count();
                                @endphp
                                <div class="col-md-6 mb-3">
                                    <div class="card border-left-info shadow-sm h-100">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <p class="mb-0 fw-bold">{{ $kategori->ktg_dok_kry }}</p>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            // ===== DATATABLE =====
            if ($.fn.DataTable.isDataTable('#dataDokumenPelaporanTable')) {
                $('#dataDokumenPelaporanTable').DataTable().destroy();
            }

            var table = $('#dataDokumenPelaporanTable').DataTable({
                responsive: true,
                destroy: true,
                language: {
                ...
                columnDefs: [
                    ...
                    { responsivePriority: 3, targets: [16, 11] }
                ],
            ...
            $('#exportExcel').on('click', function () {
                ...
                window.location.href = "{{ route('data-dokumen-laporan.index') }}?export=excel&" + formData;
            });
