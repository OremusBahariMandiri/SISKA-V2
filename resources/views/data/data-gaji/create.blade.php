                                    ...
                                    <div class="row align-items-stretch">
                                            ...
                                            <div class="card border-primary mb-4 flex-fill">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <label
                                                                class="col-sm-5 col-form-label fw-bold text-black">Jumlah
                                                                Pendapatan Tetap</label>
                                                            <div class="col-sm-7">
                                                                <div class="input-group">
                                                                    <span class="input-group-text">Rp</span>
                                                                    <input type="text"
                                                                        class="form-control fw-bold text-black text-end"
                                                    ...
                                                    <!-- Pendapatan Tidak Tetap Section -->
                                                    <div>
                                                        <h6 class="text-success fw-bold mb-3 pb-2 border-bottom">
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <label for="bonus"
                                                                class="col-sm-5 col-form-label">Bonus</label>
                                                            <div class="col-sm-7">
                                                                <div class="input-group">
                                                                    <span class="input-group-text">Rp</span>
                                                                    <input type="number" class="form-control"
                                                        ...
                                                        <div class="row mb-3 align-items-center">
                                                            <label for="thr"
                                                                class="col-sm-5 col-form-label">Tunjangan Hari Raya
                                                                (THR)</label>
                                                            <div class="col-sm-7">
                                                                <div class="input-group">
                                                                    <span class="input-group-text">Rp</span>
                                        ...
                                        <div class="col-md-6 d-flex flex-column">
                                            <div class="card border-danger mb-4 flex-fill">
                                                ...
                                                <div class="card-body">
                                                    <div class="row mb-3 align-items-center">
                                                        <label for="bpjs_tkj" class="col-sm-5 col-form-label">BPJS
                                                            Naker</label>
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="number" class="form-control" id="bpjs_tkj"
                                                                    name="bpjs_tkj" value="{{ old('bpjs_tkj', 0) }}"
                                                                    min="0" step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        <label for="bpjs_kes" class="col-sm-5 col-form-label">BPJS
                                                            Kesehatan</label>
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="number" class="form-control" id="bpjs_kes"
                                                                    name="bpjs_kes" value="{{ old('bpjs_kes', 0) }}"
                                                                    min="0" step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    ...
                                                                    value="{{ old('iuran_koperasi', 0) }}" min="0"
                                                                    step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="number" class="form-control" id="tps_kry"
                                                                    name="tps_kry" value="{{ old('tps_kry', 0) }}"
                                                                    min="0" step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="number" class="form-control" id="pjk_pkp"
                                                                    name="pjk_pkp" value="{{ old('pjk_pkp', 0) }}"
                                                                    min="0" step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="number" class="form-control" id="pjk_pph"
                                                                    name="pjk_pph" value="{{ old('pjk_pph', 0) }}"
                                                                    min="0" step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="number" class="form-control" id="ptg_thr"
                                                                    name="ptg_thr" value="{{ old('ptg_thr', 0) }}"
                                                                    min="0" step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="number" class="form-control" id="pjm_kop"
                                                                    name="pjm_kop" value="{{ old('pjm_kop', 0) }}"
                                                                    min="0" step="100">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        <label class="col-sm-5 col-form-label fw-bold text-black">Jumlah
                                                            Potongan</label>
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <span class="input-group-text">Rp</span>
                                            ...
                                            <div class="card border-primary mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-3">
                                                                <label class="form-label fw-bold text-black">Total
                                                                    Pendapatan</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">Rp</span>
                                                                    <input type="text"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group mb-3">
                                                                <label class="form-label fw-bold text-black">Gaji
                                                                    Diterima</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text">Rp</span>
                                                                    <input type="text"
                                                                        class="form-control fw-bold text-black fs-5 text-end"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="pend_jenjang_skl"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="pend_fakultas_skl"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="pend_jurusan_skl"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="pend_kota_skl"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="pend_gelar_skl"
                                                            readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="karir_skt_dep"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="karir_skt_jbt"
                                                            readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
...
@push('styles')
    ...
    <style>
        ...
        /* TEXT ALIGN RIGHT UNTUK INPUT DI BEBAN TANGGUNGAN PERUSAHAAN */
        #bpjs_tkj_prs,
        #bpjs_kes_prs,
        #tps_prs,
        #askes_prs {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function hitungSemua() {
                const tetap = getVal('gj_pokok') + getVal('tunjab') + getVal('tunkom') + getVal('fot') + getVal(
                    'tunmal');
            ...
            // =====================================================
            // STATUS DATA GAJI HANDLER - PERBAIKAN #1
            // =====================================================
            document.getElementById('sts_data_gaji').addEventListener('change', function() {
                const status = this.value;
                const fieldTglNa = document.getElementById('field_tgl_na');
                const fieldKetNa = document.getElementById('field_ket_na');

                if (status === 'NON-AKTIF') {
                    fieldTglNa.style.display = 'block';
                    fieldKetNa.style.display = 'block';
                    document.getElementById('tgl_na_gaji').focus();
                } else {
                    fieldTglNa.style.display = 'none';
                    fieldKetNa.style.display = 'none';
                    document.getElementById('tgl_na_gaji').value = '';
                    document.getElementById('ket_na_gaji').value = '';
                }
            });
                ...
                Swal.fire({
                    ...
                    if (result.isDismissed && result.dismiss === Swal.DismissReason.cancel) {
                        window.location.href =
                            `/data-gaji?filter_nama=${encodeURIComponent(response.employee_name)}`;
                    }
                });
            }
            ...
            async function checkEmployeeExists(karyawanId) {
                try {
                    ...
                    if (response.success === true && response.exists === false) {
                        ...
                        $('#id_karyawan').closest('.input-group').find('.form-select').addClass(
                            'employee-validation-success');
                        setTimeout(() => {
                            $('#id_karyawan').closest('.input-group').find('.form-select').removeClass(
                                'employee-validation-success');
                        }, 4000);
                        return true;
            ...
            async function loadEmployeeData(karyawanId) {
                ...
                $('#emp_nik, #emp_nrk, #emp_sex, #emp_tpt_lahir, #emp_tgl_lahir, #emp_tlp1, #emp_sts_nikah, #emp_jml_anak, #emp_email')
                    .val(loading);
            ...
            function clearAllEmployeeFields() {
                ...
                $('#emp_foto_placeholder').show();
                $('#pend_jenjang_skl, #pend_tgl_lulus_skl, #pend_institusi_skl, #pend_fakultas_skl, #pend_jurusan_skl, #pend_kota_skl, #pend_gelar_skl')
                    .val('');
                $('#karir_departemen_nama, #karir_skt_dep, #karir_jabatan_nama, #karir_skt_jbt, #karir_wilker_nama, #karir_unit_krj_nama, #karir_skt_wilker, #karir_tugas')
                    .val('');
            ...
            document.getElementById('dataGajiForm').addEventListener('submit', function(e) {
                ...
                this.querySelectorAll('[data-required="true"]').forEach(f => f.classList.remove(
                    'is-invalid'));
